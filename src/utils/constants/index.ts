...
export const COPYRIGHT_TEXT = 'Copyright 2021 HLS';
...
export const NO_JOKE_TEXT =
  "That's all the jokes for today! Come back another day!";

export const VOTE_TITLE: {
  [key in VoteStatus]: string;
} = {
  [VoteStatus.like]: 'This is funny!',
  [VoteStatus.dislike]: 'This is not funny',
};

export const VOTE_STORAGE_KEY = 'votes';
